...
\vspace{6mm}
\fbox{\fbox{\parbox{6in}{\centering\small Tienes 30 minutos para responder tantos incisos como puedas. Cada pregunta de otorga un cierto número de puntos, los cuáles solo obetendrás en su totalidad si tu respuesta es correcta y completa.\\Si tu respuesta es parcialmente correcta, obtendrás una parte proporcional de los puntos.}}}
\end{center}
\begin{questions}
